...
export const campaignSchema = z.object({
  ...
  drawScheduledAt: z.string().optional(),
  sponsorName: z.preprocess(emptyToNull, z.string().max(160).nullable()),
  eligibilitySummary: z.preprocess(emptyToNull, z.string().max(1000).nullable()),
  prizeValueSummary: z.preprocess(emptyToNull, z.string().max(1000).nullable()),
  jurisdictionNotice: z.preprocess(emptyToNull, z.string().max(1000).nullable()),
